    ...
    >
      <div className="text-center text-white sm:text-left">
        ...
        <ul className="mt-8 space-y-4 text-sm">
          <li>
            <a className=" text-white transition hover:text-gray-700/75" href="#"> Lorem Ipsum is simply dummy text of the printing and typesetting industry.  </a>
          </li>


          <li>
            <a className=" text-white transition  hover:text-gray-700/75" href="#"> @Lorem </a>
          </li>
        </ul>
      </div>
      ...
      <div className="text-center sm:text-left">
        ...
        <ul className="mt-8 space-y-4 text-sm">
          ...
          <li>
            <a className=" text-white transition hover:text-gray-700/75" href="#"> Portfolio </a>
          </li>
          ...
          <li>
            <a className=" text-white transition hover:text-gray-700/75" href="#"> Contact us </a>
          </li>
        </ul>
      </div>
